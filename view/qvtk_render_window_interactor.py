...
class QVTKRenderWindowInteractor(QtGui.QWidget):
    ...
    def __init__(self, parent=None, wflags=QtCore.Qt.WindowFlags(), **kw):
        ...
        #bug fixed by me "Alvaro Javier"
        if parent is not None:
            self._RenderWindow.SetParentId(str(int(self.parentWidget().winId())))
    ...
    #added by me "Alvaro Javier"
    def setParent(self, parent):
        super(QVTKRenderWindowInteractor, self).setParent(parent)
        self._RenderWindow.SetParentId(str(int(self.parentWidget().winId())))
    ...
    def ShowCursor(self):
        ...
        self.setCursor(qt_cursor) #bug fixed by me "Alvaro Javier"
